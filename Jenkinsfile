        ...
        if (!pullRequest) {
            ...
            container('kubectl') {
                stage('Deploy MicroService') {
                   ...
                   sh "sed -e 's/{{INGRESSIP}}/'${ingressAddress}'/g' ./deployment/ingress.yaml > ./deployment/ingress2.yaml"
            ...
            container('kubectl') {
               ...
               sh "sed -e 's/{{INGRESSIP}}/'${ingressAddress}'/g' ./deployment/prod-ingress.yaml > ./deployment/prod-ingress2.yaml"
